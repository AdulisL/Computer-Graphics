/** Created by: 
 * Meron Asfaw (masfaw@ucsd.edu)
 * CSE167-FALL22, Sep 2022
 */
#include <iostream>
#ifdef __APPLE__
...
void initialize(void){
    ...
    GLfloat colors[] = {
        ...
        0.0f, 0.0f, 1.0f, // pt2: blue
        0.0f, 1.0f, 0.0f, // pt3: green
        0.0f, 0.0f, 1.0f, //  pt4: red
        1.0f, 1.0f, 0.0f, //  pt5: yellow
        0.0f, 1.0f, 0.0f, //  pt6: green
        0.0f, 0.0f, 1.0f  //  pt7: blue
    };
    // IndexBuffer
...
void keyboard(unsigned char key, int x, int y){
    switch(key){
        case 27: // Escape to quit
            system("make clean"); // cleanes current compile
            exit(0);
            break;
        case 'h': // print help
            printHelp();
